(function () {
    ...
    angular
        .module('main')
        .controller('otherProductsListController', otherProductsListController);

    otherProductsListController.$inject = ['$scope', '$location', 'appSession', 'abp.services.app.finishProduct', 'abp.services.app.productGrade',
    ...
    function otherProductsListController($scope, $location, appSession, finishProductService, productGradeService,
        productApiService, productCategoryService, productUnitService, brandService, productService) {
        var vm = this;
        vm.title = 'Other Product List';
        ...
        vm.displayOtherProductDetails = function () {

            var productId = angular.copy(vm.selectedRowEntity.id);
            vm.disableEdit = true;
            $location.path('/OtherProduct/detail/' + productId);
        };
